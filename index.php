...
<html lang="en" class="no-js">
	<head>
		...
		<!-- Bootstrap -->
		<script src="etc/js/modernizr.custom.js"></script>
		<link href="etc/css/bootstrap.min.css" rel="stylesheet">
		<link href="etc/css/jquery.fancybox.css" rel="stylesheet">
		<link href="etc/css/flickity.css" rel="stylesheet" >
		<link href="etc/css/animate.css" rel="stylesheet">
		<link href="http://maxcdn.bootstrapcdn.com/font-awesome/4.2.0/css/font-awesome.min.css" rel="stylesheet">
		<link href='http://fonts.googleapis.com/css?family=Nunito:400,300,700' rel='stylesheet' type='text/css'>
		<link href="etc/css/styles.css" rel="stylesheet">
		<link href="etc/css/queries.css" rel="stylesheet">
	...
	<body>
				...
				<div class="container">
					<div class="row nav-wrapper">
						<div class="col-md-6 col-sm-6 col-xs-6 text-left">
							<a href="#">Legoom
							<!-- <img src="etc/img/logo-white.png" alt="Legoom Logo"> -->
							</a>
						</div>
					...
					<div class="row hero-content">
						<div class="col-md-12">
							<h1 class="animated fadeInDown">An Exclusive, Human Resource &amp; Management Systems created exlusively for Legoomers.</h1>
							<a href="/li-api" class="use-btn animated fadeInUp">Linkedin API</a> <a href="/intern-report/login" class="learn-btn animated fadeInUp">Intern Report <i class="fa fa-arrow-down"></i></a>&nbsp;&nbsp;<a href="/intern-report/application" class="learn-btn animated fadeInUp">Application Form </a>
						</div>
					</div>
				</div>
			</section>
					...
					<!-- <div class="col-md-6 nopadding features-intro-img"> -->
						<!-- <div class="features-bg"> -->
							...
							<!-- <div class="features-img wp1"> -->
								<!-- <img src="etc/img/html5-logo.png" alt="HTML5 Logo"> -->
							<!-- </div> -->
						<!-- </div> -->
					<!-- </div> -->
					...
					<!-- <div class="row"> -->
								...
								<!-- <div class="device-content"> -->
									<!-- <div class="showcase-slider"> -->
										<!-- <ul class="slides" id="showcaseSlider"> -->
											<!-- <li> -->
												<!-- <img src="etc/img/screen1.jpg" alt="Device Content Image"> -->
											<!-- </li> -->
											<!-- <li> -->
												<!-- <img src="etc/img/screen2.jpg" alt="Device Content Image"> -->
											<!-- </li> -->
											<!-- <li> -->
												<!-- <img src="etc/img/screen3.jpg" alt="Device Content Image"> -->
											<!-- </li> -->
										<!-- </ul> -->
									<!-- </div> -->
								<!-- </div> -->
						...
						<!-- <div class="col-md-6"> -->
							...
							<!-- <blockquote class="team-quote"> -->
								<!-- <div class="avatar"><img src="etc/img/avatar.png" alt="User Avatar"></div> -->
								...
								<!-- <div class="logo-quote"> -->
									<!-- <a href="http://tympanus.net/codrops/"><img src="etc/img/codrops-logo.png" alt="Codrops Logo"></a> -->
								<!-- </div> -->
							<!-- </blockquote> -->
			...
			<!-- <div class="container-fluid"> -->
				<!-- <div class="row"> -->
					<!-- <ul class="grid"> -->
						<!-- <li> -->
							<!-- <figure> -->
								<!-- <img src="etc/img/01-screenshot.jpg" alt="Screenshot 01"> -->
								<!-- <figcaption> -->
								<!-- <div class="caption-content"> -->
									<!-- <a href="etc/img/large/01.jpg" class="single_image"> -->
						...
						<!-- <li> -->
							<!-- <figure> -->
								<!-- <img src="etc/img/02-screenshot.jpg" alt="Screenshot 01"> -->
								<!-- <figcaption> -->
								<!-- <div class="caption-content"> -->
									<!-- <a href="etc/img/large/02.jpg" class="single_image"> -->
										<!-- <i class="fa fa-search"></i><br> -->
						...
						<!-- <li> -->
							<!-- <figure> -->
								<!-- <img src="etc/img/03-screenshot.jpg" alt="Screenshot 01"> -->
								<!-- <figcaption> -->
								<!-- <div class="caption-content"> -->
									<!-- <a href="etc/img/large/03.jpg" class="single_image"> -->
										<!-- <i class="fa fa-search"></i><br> -->
						...
						<!-- <li> -->
							<!-- <figure> -->
								<!-- <img src="etc/img/04-screenshot.jpg" alt="Screenshot 01"> -->
								<!-- <figcaption> -->
								<!-- <div class="caption-content"> -->
									<!-- <a href="etc/img/large/04.jpg" class="single_image"> -->
										<!-- <i class="fa fa-search"></i><br> -->
										<!-- <p>Absolutely Free</p> -->
									<!-- </a> -->
								<!-- </div> -->
				...
				<!-- <div class="row"> -->
					<!-- <ul class="grid"> -->
						<!-- <li> -->
							<!-- <figure> -->
								<!-- <img src="etc/img/05-screenshot.jpg" alt="Screenshot 01"> -->
								<!-- <figcaption> -->
								<!-- <div class="caption-content"> -->
									<!-- <a href="etc/img/large/05.jpg" class="single_image"> -->
										<!-- <i class="fa fa-search"></i><br> -->
						...
						<!-- <li> -->
							<!-- <figure> -->
								<!-- <img src="etc/img/06-screenshot.jpg" alt="Screenshot 01"> -->
								<!-- <figcaption> -->
								<!-- <div class="caption-content"> -->
									<!-- <a href="etc/img/large/06.jpg" class="single_image"> -->
										<!-- <i class="fa fa-search"></i><br> -->
						...
						<!-- <li> -->
							<!-- <figure> -->
								<!-- <img src="etc/img/07-screenshot.jpg" alt="Screenshot 01"> -->
								<!-- <figcaption> -->
								<!-- <div class="caption-content"> -->
									<!-- <a href="etc/img/large/07.jpg" class="single_image"> -->
										<!-- <i class="fa fa-search"></i><br> -->
										<!-- <p>Made with Love</p> -->
									<!-- </a> -->
								<!-- </div> -->
						...
						<!-- <li> -->
							<!-- <figure> -->
								<!-- <img src="etc/img/08-screenshot.jpg" alt="Screenshot 01"> -->
								<!-- <figcaption> -->
								<!-- <div class="caption-content"> -->
									<!-- <a href="etc/img/large/08.jpg" class="single_image"> -->
										<!-- <i class="fa fa-search"></i><br> -->
			...
			<div class="container">
				<div class="row">
					<div class="col-md-5">
						...
						<img src="etc/img/logo-blue.png" alt="Footer Logo Blue">
						</h1>
		...
		<script src="etc/js/min/toucheffects-min.js"></script>
		<script src="https://ajax.googleapis.com/ajax/libs/jquery/1.11.0/jquery.min.js"></script>
		<script src="etc/js/flickity.pkgd.min.js"></script>
		<script src="etc/js/jquery.fancybox.pack.js"></script>
		<!-- Include all compiled plugins (below), or include individual files as needed -->
		<script src="etc/js/retina.js"></script>
		<script src="etc/js/waypoints.min.js"></script>
		<script src="etc/js/bootstrap.min.js"></script>
		<script src="etc/js/min/scripts-min.js"></script>
